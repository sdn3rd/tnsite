...
function showLoveOverlay() {
    ...
    const loveMessage = `
        <p>I know I said I'd take a break from writing, but then I thought, if tomorrow were my last day, would I regret not saying this? So, here goes. If you happen to be free Thursday through Saturday or the following weekend, I'll be in Milan.  It would be great to meet for a coffee or a chat, if you're interested. You're truly a remarkable person - so intelligent and delightful.  Honestly, I'm still trying to understand this lingering connection I feel to you, even now. Maybe it's just fondness, maybe it's something more. And perhaps you feel it too, in some way. I'm open to whatever the truth might be. Of course, meeting up is entirely your choice, and I'm completely fine if it's not something you'd like to do.  Also, a reminder that my poetry sometimes just comes from a fleeting mood or a song, so please don't feel pressured to read too much into it! Either way, I genuinely wish you the best.</p>
    `;
