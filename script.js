...
let rowHeight = 40;             // approximate row height
...
function showPoemWheel(){
  ...
  poemsForWheel.forEach((poem, idx)=>{
    ...
    tr.innerHTML=`<td>${titleUsed||"Untitled"}</td>`;

    // Center-row click => reading mode
...
/** Drag logic for the "wheel" table */
...
/** Reading overlay for both single-poem (mobile) or wheel center */
